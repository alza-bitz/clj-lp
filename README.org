...
#+BEGIN_EXAMPLE
# run "free" tests (tests with no license requirements)
$ clj -X:test:test-free
#+END_EXAMPLE

#+BEGIN_EXAMPLE
# run "paid" tests (tests with paid license requirements, e.g. gurobi)
$ clj -X:test:test-paid
#+END_EXAMPLE
